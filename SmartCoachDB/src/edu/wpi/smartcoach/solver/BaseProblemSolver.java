...
//				state.get(current).setLocation((ExerciseLocation)locationResponse.getSelectedValue());
//				
//			} else if(id.equals("time")){
//				
//				OptionQuestionModel timeResponse = (OptionQuestionModel)response;
//				state.get(current).setTime((ExerciseTime)timeResponse.getSelectedValue());
//				
//				
//			} else if(id.equals("frequency")){
//				
//				OptionQuestionModel freqResponse = (OptionQuestionModel)response;
//				state.get(current).setFrequency(0);
//				
...
//				
//				if(we.getSelectedOption().getId() != YES){
